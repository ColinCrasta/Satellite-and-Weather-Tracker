        ...
        if (satData[key]["iteration "] === 0) {
          ...
          return (
            <tr key={count}>
              ...
              <td>9000</td>
              <td>
                {satData[key]["lat"].split("deg")[0]}:
                {satData[key]["lon"].split("deg")[0]}
              </td>
        ...
        <div>
          ...
          <form onSubmit={handleSat}>
            <div>
              <label>
                {" "}
                Enter the name of the satellite you would like to store data
                for:{" "}
              </label>
          ...
          <form onSubmit={handleStation}>
            ...
            <div>
              <label>
                {" "}
                Real time data of the weather and signal data for the ground
                station located at {ground}
              </label>
